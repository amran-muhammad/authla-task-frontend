...
const centeredActionsInstruction = ref(false)
const permissionBlock = ref(false)
...
const testSuccess = async (length: string, index: number, item: any) => {
  if (
    AudioDevicePermission.value == false &&
    VideoDevicePermission.value == false
  ) {
    permissionBlock.value = true
  } else {
    _stop(videoForTest[index].srcObject)
    jobOpening.start_text[index] = 'Start'
    await sleep(100)
    Record(length, index, item)
  }
}
...
const nextStepVideo = async () => {
  centeredActionsInstruction.value = false
...
onMounted(() => {
  ...
  } else if (!jobApplication.basic_info.job_opening_id) {
    router.push('/')
  } else {
    router.push('/')
  }
...
<template>
  ...
  >
    ...
    <VModal
      :open="centeredActionsInstruction"
      title=""
      size="large"
      actions="center"
      cancelLabel=""
      noscroll
      noclose
      @close="centeredActionsInstruction = false"
    >
      <template #content>
        <div class="instructions m-t-20 m-b-50">
          <div class="columns">
            <div class="column is-12">
              <h2>Video interview</h2>
              <p class="m-b-20">
                It's important to complete the quick interview for the recruiter
          ...
          <div class="columns">
            <div class="column is-6">
              <div class="img-cont">
                <img
                  class="correct"
                  src="/@src/assets/illustrations/2.png"
                  alt="Expired Job"
                />
                <VIconWrap icon="feather:check" hasBackground color="success" />
              </div>
              <h2>Follow</h2>
              <ol class="ol-correct">
                <li>Visible face</li>
                <li>Clear video & bright background</li>
                <li>Speak loud & clear</li>
            ...
            <div class="column is-6">
              <div class="img-cont">
                <img
                  class="incorrect"
                  src="/@src/assets/illustrations/1.png"
                  alt="Expired Job"
                />
                <VIconWrap icon="feather:x" hasBackground color="danger" />
              </div>
              <h2>Avoid</h2>

              <ol class="ol-incorrect">
                <li>Sit in crowded environment</li>
                <li>Avoid short, unclear answers</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <template #action>
        <VButton @click="nextStepVideo" color="primary" bold
          >I understand</VButton
        >
      </template>
    </VModal>
    ...
    <VModal
      ...
      actions="center"
      cancelLabel="Close"
      @close="permissionBlock = false"
    >
      <template #content>
        <!-- <VPlaceholderSection title="" subtitle=" " /> -->

        <h3 class="title is-5 m-b-10">
          <i
            class="fas fa-exclamation-circle m-r-5"
        ...
        <p>
          <small>
            Tenrol requires access to your camera and microphone. Click camera
            block icon and microphone blocked icon in your browser's address bar
          </small>
        </p>
      </template>
    </VModal>
    <div class="form-outer">
          ...
          <div class="right">
            <VButtons v-if="jobOpening.showQIndex > -1">
              ...
              <VButton
                ...
                "
                color="primary"
                @click="centeredActionsInstruction = true"
              >
                Start Interview
              </VButton>
            </VButtons>
            ...
            <VButtons v-if="jobOpening.showVideoIndex > -1">
              ...
              <VButton
                bold
                v-if="jobApplication.progress == 100"
                color="primary"
                @click="updateInterview"
              >
                Complete Interview
      ...
      <div class="form-body form-body-question">
        <!-- Question text -->
        <div
                      ...
                      >
                        ...
                        <span
                          v-if="
                            !permissionBlock &&
                            !centeredActionsOpen &&
                            jobOpening.start_text[index] == 'Retake'
                          "
                          class="mins"
                        >
                          {{
                        ...
                        <span
                          v-else-if="!permissionBlock && !centeredActionsOpen"
                          class="mins"
                        >
                          {{
                            Number(item.length) > 59
                        ...
                        >
                          ...
                          <VButton
                            ...
                            outlined
                            bold
                            @click="testSuccess(item.length, index, item)"
                          >
...
.instructions {
  ...
  .correct {
    border: 0.25rem solid var(--success) !important;
  }
  .incorrect {
    border: 0.25rem solid var(--danger) !important;
  }
  h2 {
