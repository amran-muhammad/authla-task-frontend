      ...
      <ul>
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink
                :to="{ name: 'sidebar-layouts-form-layouts-0' }"
                class="is-submenu"
              >
                <i aria-hidden="true" class="lnil lnil-passport"></i>
                <span>Form Layout Job Opening</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink
                :to="{ name: 'sidebar-layouts-data-list-0' }"
                class="is-submenu"
              >
                <i aria-hidden="true" class="lnil lnil-passport"></i>
                <span>Data List Job Opening</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'login' }" class="is-submenu">
