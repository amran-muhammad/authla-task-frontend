      ...
      <div id="vuero-landing" class="hero is-fullheight rounded-hero is-active">
        ...
        <div class="section">
          <div class="container">
            ...
            <p>Welcome to tenrol.com!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Tenrol's Website, located at tenrol.com.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use tenrol.com if you do not agree
            ...
            <p>
              We employ the use of cookies. By accessing tenrol.com, you agreed
              to use cookies in agreement with the Tenrol's Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, Tenrol and/or its licensors own the
              intellectual property rights for all material on tenrol.com. All
              intellectual property rights are reserved. You may access this
              from tenrol.com for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from tenrol.com</li>
              <li>Sell, rent or sub-license material from tenrol.com</li>
              <li>Reproduce, duplicate or copy material from tenrol.com</li>
              <li>Redistribute content from tenrol.com</li>
            </ul>
            ...
            <p>
              ...
              Tenrol does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of Tenrol,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, Tenrol
            ...
            <p>
              Tenrol reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant Tenrol a non-exclusive license to use, reproduce,
            ...
            <p>
              ...
              Tenrol; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Tenrol. Please include your name, your
            ...
            <p>
              No use of Tenrol's logo or other artwork will be allowed for
